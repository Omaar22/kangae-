...
public class Register implements Register_Interface {
	...
	public Register(String name, String email, String userName,
			String password, String studyCateg, String role, int age) {
		super();
		Name = name;
		Email = email;
		UserName = userName;
	...
	public void SaveAccount(Register r) {
		Account a = new Account(r.getName(), r.getEmail(), r.getUserName(),
				r.getPassword(), r.getRole(), r.getStudyCateg(), r.getAge());
		a.Save(a);
	}
