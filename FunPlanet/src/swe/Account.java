...
public class Account {
	...
	public Account(String name, String email, String userName, String password, String studyCateg, String role,int age) {
		super();
		Name = name;
		Email = email;
		UserName = userName;
	...
	public Account Search(String username, String password) throws FileNotFoundException{
