...
public class CreateGameTest1 {
  ...
  @Test
  public void testCreateGameTest1() throws Exception {
    ...
    driver.findElement(By.id("inputGameQuestion")).sendKeys("bla");
    driver.findElement(By.id("inputGameAnswer")).clear();
    driver.findElement(By.id("inputGameAnswer")).sendKeys("blabla");
    driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();
  }
